...
- Page editors keep their paste, save, selection, and other editing keys; Search's overlapping shortcuts still work when no editor has focus. ([#147](https://github.com/driceroland/Search/issues/147))
